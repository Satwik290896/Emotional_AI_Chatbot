...
if __name__ == "__main__":
    ...
    for k in range(1):
        ...
        history = model.fit(X_train_indices, Y_train_oh, epochs=NEpochs, batch_size=2, shuffle=True,validation_data=(X_test_indices,y_test_oh))
    ...
    axs[0, 1].set_title('Validation dataset Accuracy')
